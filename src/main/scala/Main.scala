...
import scalafx.scene.control.{MenuBar, Menu, MenuItem, SeparatorMenuItem, CheckMenuItem, RadioMenuItem,
  MenuButton, SplitMenuButton, ContextMenu}
...
object NewApp8 extends JFXApp3 {
